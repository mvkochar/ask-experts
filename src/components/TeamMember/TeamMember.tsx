...
const TeamMember = ({id =1, image, position, bgColor = "#181818", txtColor = "#FFFFFF", fName, desc }: TeamMemberProps) => {
    return (
        <div className='team-member d-f jc-sb'>
            ...
            <Link to= {`/team-single/${id}`} className="team-member-fname">{fName}</Link>
